package com.deloitte.conversionmicroservice.controller;
...
import com.deloitte.conversionmicroservice.model.ConversionBean;
...
public class ConversionController {
	...
	public ResponseEntity<ConversionBean> getConvertedValue(@PathVariable("from") String from,@PathVariable("to") String to,
